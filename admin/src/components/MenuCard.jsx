      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {items && items.length > 0 ? (
          items.map((item) => {
            ...
            return (
              /* Wrap Card in TiltCard */
              <TiltCard
                key={item._id || item.id}
                className="bg-white w-85 mb-3 rounded-2xl shadow-md hover:shadow-2xl transition-shadow duration-300 overflow-hidden border border-gray-100 flex flex-col justify-between transform-gpu"
              >
                {/* Image Section */}
