...
const NewPass = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                `${import.meta.env.VITE_CLIENT_API_URL}/api/admin/reset-password`,
                {
                    email,
                    password,
                    confirmPassword
    ...
    return (
        <div className="min-h-[70vh] dark:bg-stone-900 flex items-center justify-center px-4 py-12">
            {/* Main Styled Card */}
            <div className="w-full max-w-[440px] dark:bg-stone-800 rounded-[24px] p-10 shadow-[0_10px_30px_rgba(0,0,0,0.04)] border border-[#eeeeee] text-center">
                ...
                <p className="text-[#979494] text-sm leading-relaxed mb-7">
