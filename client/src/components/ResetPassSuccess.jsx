...
const ResetPassSuccess = () => {
  return (
    <div>
      <div className="p-6  h-70 rounded-2xl bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800 text-center space-y-3">
            <CheckCircle2 className="w-10 h-10 mt-8 text-emerald-700 dark:text-emerald-400 mx-auto" />
